...
const Footer = () => {
  ...
  const contactInfo = [
    { icon: "/Contacts/Email.svg", text: "support@gmart.in", alt: "Email" },
    { icon: "/Contacts/Phone.svg", text: "1234567890", alt: "Phone" }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col items-center md:items-start space-y-6">
            ...
            <p className="text-gray-600 font-medium text-center md:text-left">
              Leading the ecommerce and quickcommerce services.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-gray-500">
              &copy; Copyright 2024 - MIT Naan Mudhalvan Students Productions.
            </p>
